...
function preload(){ 
  ...
  trex_running=loadAnimation("ast1.png","ast2.png","ast3.png"); 
  //carregamento das imagens 
  //dinossauro
  trexCollide = loadImage("trexCollide.png");
  //fundo
  groundImage = loadImage("marte.png");
  //nuvem
  cloudImage = loadImage("cloud.png");
  //obstáculos
  obstacle1 = loadImage("rover.png");
  obstacle2 = loadImage("pedra1.png");
  obstacle3 = loadImage("pedra2.png");
  obstacle4 = loadImage("pedra3.png");
  obstacle5 = loadImage("pedra4.png");
  obstacle6 = loadImage("pedra5.png");
  //reinício
...
function createObstacles() {
  ...
  if(frameCount % 60 === 0) {
    //criar obstáculos
    var obstacle = createSprite(1000,200,10,10);
